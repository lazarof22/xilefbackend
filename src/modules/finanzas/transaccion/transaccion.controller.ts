...
export class TransaccionController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Registrar transacción (Res. 101/2011, Res. 111/2023 BCC)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 400,
    description: 'Ya existe una transacción con ese código',
  })
  create(@Body() createDto: CreateTransaccionDto) {
    return this.transaccionService.create(createDto);
  }
