...
export class CreateTransaccionDto {
  ...
  @ApiPropertyOptional({
    description: 'Tasa de cambio aplicada (operaciones de divisa)',
  })
  @IsNumber()
  @IsOptional()
  tipoCambio?: number;
  ...
  @ApiPropertyOptional({
    description: 'ID de la moneda de origen (operaciones de divisa)',
  })
  @IsMongoId()
  @IsOptional()
  monedaOrigen?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Tipo de operación de cambio de divisa',
  })
  @IsEnum(TipoOperacionCambio)
  @IsOptional()
