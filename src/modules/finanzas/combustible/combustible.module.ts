...
import { TarjetaCombustible, TarjetaCombustibleSchema } from './schema/tarjeta-combustible.schema';
import { CargaCombustible, CargaCombustibleSchema } from './schema/carga-combustible.schema';
